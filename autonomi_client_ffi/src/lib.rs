...
#[no_mangle]
pub extern "C" fn get_cost_string(cost_str: *const i8) -> *mut i8 {
    if cost_str.is_null() {
        // Ако е нулев указател, използвай вътрешната версия с String
    ...
    c_string.into_raw()  // Превръщаме CString в raw указател
}
